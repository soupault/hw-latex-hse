...
% See https://github.com/AndreyAkinshin/Russian-Phd-LaTeX-Dissertation-Template/issues/89
\NewBibliographyString{langjapanese}
\NewBibliographyString{fromjapanese}
%
\addbibresource{week4_bib1.bib}
\addbibresource{week4_bib2.bib}
...
% Позволяет добавить все источники из подключенных списков
% \nocite{*}
